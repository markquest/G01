...
DATABASES = {
    'default': {
        ...
        'HOST': 'database-1-instance-1.cth3lcltumje.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'oguzapp' # please enter your s3 bucket name
